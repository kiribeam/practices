...
public class KeyBasedLargeFileProcessor
{
    ...
    {    
        ...
        try
        {
            ...
            InputStream clear = pbe.getDataStream(new JcePublicKeyDataDecryptorFactoryBuilder().build(sKey));
            ...
            if (message instanceof PGPLiteralData)
            {
                ...
                //String outFileName = new String(ld.getRawFileName());

                System.out.println(new String(ld.getFileName()));
        ...
        throws Exception
    {
        ...
        if (args.length == 0){
        	//encryptFile("e:\\code\\keys\\enkey", "e:\\code\\keys\\1234.txt", "e:\\code\\keys\\pub.asc",true , true);
        	decryptFile("e:\\code\\keys\\enkey", "e:\\code\\keys\\sec.key", "1234".toCharArray(), "e:\\code\\keys\\enkey.asc.out");
