...
public class Test2{
  public static void main(String[] args){
    ProjectDataOperate.createNewProjectData("Test2");
    ProjectData pd = ProjectDataOperate.loadProjectData("ProjectData/Test2.ruri");
    ...
    var33.type = 0;
    var33.addr = "0003";
    var33.device = sd3;    ArrayList<Var> rt1 = sd1.varList;
    ...
    ProjectDataOperate.saveProjectData(pd);
    System.out.println("size is : " + pd.socketDevices.size());
